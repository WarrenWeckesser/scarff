...
def savearff(fileobj, a, *, attributes=None, relation=None,  missing=None,
    ...
    This function does not support "date" or "relational" attribute types,
    ...
    dateformat : str, optional
        ...
        the be default, which is the ISO-8601 combined date and time format
    ...
    >>> bprint(f.getvalue())
    |% ARFF file generated by scipy.io.arff.savearff.
    |% Created 15-Nov-2015 11:37:37
    |
    |@relation undefined
    |
    |@attribute f0 real
    ...
    >>> dt = np.dtype([('r', np.float64), ('code', np.int32), ('s', 'S8')])
